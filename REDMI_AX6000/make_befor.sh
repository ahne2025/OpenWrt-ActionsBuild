...
##任务设置调到系统菜单
# sed -i '8d' package/feeds/jell/luci-app-taskplan/luasrc/controller/*.lua
# sed -i '/firstchild/d' package/feeds/jell/luci-app-taskplan/luasrc/controller/*.lua
# sed -i 's/"control"/"system"/g' package/feeds/jell/luci-app-taskplan/luasrc/controller/*.lua
